...
public class GroupDemo {
    ...
    public static void main(String[] args) {
        ...
        Student student8 = new Student("kk", 20, 3, new Date());
        ...
        List<String> collect2 = list.stream().map(Student::getName).distinct().collect(Collectors.toList());
